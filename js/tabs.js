$(document).ready(function(){
  ...
  function tabs(boxTabsLink){ 
    $(boxTabsLink + ' a').on('click', function(e){ 
      ...
      $(boxTabsLink + ' ~ .nomination__box').removeClass('nomination__box--visible');
      setTimeout(function() {
        $(boxTabsLink + ' ~ .nomination__box').removeClass('nomination__box--selected');
      }, 200);
      setTimeout(function() {
        $(idBox).addClass('nomination__box--selected');
      }, 200);
      setTimeout(function() {
        $(boxTabsLink + ' ~ .nomination__box--selected').addClass('nomination__box--visible');
      }, 300);
